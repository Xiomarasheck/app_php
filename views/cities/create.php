    ...
    <body>
        <section class="principalBanner">
             <div class="contentLogin"
                ...
                <div class="center">
                    <form class="formRegister animated bounceInDown fast" action="/processActions.php?controller=cities&method=create" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <select id="id_departamento" class="form-control m-b" required="required" name="id_departamento">
                                <option value="" selected="selected">Departamento...</option>
                                <?php if(isset($allDepartments) && count($allDepartments)>=1) {?>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" required="required" class="form-control" name="descripcion" id="descripcion" aria-describedby="emailHelp" placeholder="Nombre Ciudad">
                        </div>
                        <hr>
